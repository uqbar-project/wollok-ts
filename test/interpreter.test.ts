...
//         const evaluation = Evaluation(environment, {}, { 1: { id: '1', parentContext: '', locals: new Map([['x', '1']]) } })(Frame({ context: '1', operandStack: ['2'], instructions: [instruction] }))

//         evaluation.should.be.stepped().into(Evaluation(environment, {}, { 1: { id: '1', parentContext: '', locals: new Map([['x', '1']]) } })(Frame({ context: '1', operandStack: ['2', '1'], instructions: [instruction], nextInstruction: 1 })))
//       })
...
//           2: { id: '2', parentContext: '1', locals: new Map([['x', '2']]) },
//           3: { id: '3', parentContext: '2', locals: new Map([['x', '1']]) },
//           4: { id: '4', parentContext: '3', locals: new Map() },
//         })(
...
//         const instruction = LOAD('x')
//         const evaluation = Evaluation(environment, {}, { 1: { id: '1', parentContext: null, locals: new Map() } })(Frame({ context: '1', instructions: [instruction] }))
...
//         evaluation.should.be.stepped().into(Evaluation(environment, {}, {
//           1: { id: '1', parentContext: '', locals: new Map([['x', '1']]) },
//           2: { id: '2', parentContext: '1', locals: new Map() },
//         })(
...
//         const instruction = STORE('x', false)
//         const evaluation = Evaluation(environment, {}, { 1: { id: '1', parentContext: '', locals: new Map([['x', '2']]) } })(Frame({ context: '1', operandStack: ['1'], instructions: [instruction] }))


//         evaluation.should.be.stepped().into(Evaluation(environment, {}, { 1: { id: '1', parentContext: '', locals: new Map([['x', '1']]) } })(Frame({ context: '1', instructions: [instruction], nextInstruction: 1 })))
//       })
...
//         const evaluation = Evaluation(environment, {}, {
//           1: { id: '1', parentContext: '', locals: new Map([['x', '2']]) },
//           2: { id: '2', parentContext: '1', locals: new Map([['x', '2']]) },
//           3: { id: '3', parentContext: '2', locals: new Map() },
//         })(
...
//         evaluation.should.be.stepped().into(Evaluation(environment, {}, {
//           1: { id: '1', parentContext: '', locals: new Map([['x', '2']]) },
//           2: { id: '2', parentContext: '1', locals: new Map([['x', '1']]) },
//           3: { id: '3', parentContext: '2', locals: new Map() },
//         })(
...
//         const instruction = STORE('x', true)
//         const evaluation = Evaluation(environment, {}, { 1: { id: '1', parentContext: null, locals: new Map() } })(Frame({ context: '1', operandStack: ['1'], instructions: [instruction] }))


//         evaluation.should.be.stepped().into(Evaluation(environment, {}, { 1: { id: '1', parentContext: null, locals: new Map([['x', '1']]) } })(Frame({ context: '1', instructions: [instruction], nextInstruction: 1 })))
//       })
...
//         const evaluation = Evaluation(environment, {})(Frame({ operandStack: ['2'], instructions: [instruction] }))


//         evaluation.should.be.stepped().into(Evaluation(environment, {})(Frame({ operandStack: ['2', '1'], instructions: [instruction], nextInstruction: 1 })))
//       })
