...
//       const actual = `import //some comment
//   p`

//       const parsedLine = parser.parse(actual)
//       expect(parsedLine.status).toBe(true)
//       if (!parsedLine.status) throw new Error('Parse failed')

//       expect(parsedLine.value).into(
//         new Import({
//           entity: new Reference({
//             name: 'p',
//             metadata: [
...
//       expect(parsedLine.value.entity).tracedTo([0, 29])
...
//       expect(entityNode).tracedTo([28, 29])
//     })
...
//       textFor(result, expect(input)).toBe('class')
//     })
...
//       textFor(result, expect(input)).toBe('method fly()')
//     })
