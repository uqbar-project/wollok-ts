...
// import { Category, Class, Constructor, Describe, Entity, Environment, Filled as FilledStage, Id, Kind, Linked as LinkedStage,
// List, Method, Module, Name, Node, Package, Raw as RawStage, Reference, Singleton, Stage } from './model'
import { Id, List, Module, Name } from './model'
